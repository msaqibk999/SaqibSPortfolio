    ...
    <>
      <LazyMotion features={domAnimation}>
        <div className={styles.mainContainer} id='home'>
          ...
          <m.div initial={{ x: '-100vw' }} animate={{ x: 0 }} transition={{ duration: 0.8 }} className={styles.dp}>
            {imageLoaded ? (
          ...
          <div className={styles.infoContainer}>
            ...
            <Reveal isSlider={true} width='fit-content'>
              <div className={styles.info}>
                Designing the future with code, where innovation and creativity merge seamlessly.
              </div>
            </Reveal>
            <div className={styles.linkContainer}>
              ...
              <m.button
                initial={{ x: '100vw' }}
                animate={{ x: 0 }}
                transition={{ duration: 0.8, delay: 0.25, type: 'spring', stiffness: 40 }}
                className={styles.link}
              ...
              <m.button
                initial={{ x: '100vw' }}
                animate={{ x: 0 }}
                transition={{ duration: 0.8, delay: 0.4, type: 'spring', stiffness: 40 }}
                className={styles.link}
            ...
            <Reveal width='100%'>
              <m.button className={styles.btn} onClick={handleContactMeClick}></m.button>
            </Reveal>
          </div>
          <m.div
            initial={{ y: '-100vw' }}
